    ...
    return (
        <>
                ...
                <div className="container-superhi relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <button onClick={() => setFormOpen(true)} className="px-8 py-3.5 bg-vibrant-crimson text-white rounded-full font-bold shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2">
            ...
            <ProcessSection
                ...
                title={<>From application to <span className="font-display text-vibrant-crimson">your first real project in days</span></>}
                ...
                <div className="container-superhi">
                    <div className="text-center max-w-2xl mx-auto">
                        <h2 className="heading-section mb-6">
                            Ready to start your{" "}
                            <span className="font-display text-vibrant-crimson">journey</span>?
                        </h2>
                        ...
                        <button onClick={() => setFormOpen(true)} className="px-8 py-3.5 bg-vibrant-crimson text-white rounded-full font-bold shadow-lg hover:-translate-y-0.5 transition-all inline-flex items-center gap-2">
                            Fill Out Application <ArrowRight className="w-4 h-4" />
                        </button>
                    </div>
                </div>
