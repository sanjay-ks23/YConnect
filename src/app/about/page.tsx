    ...
    return (
        <div className="relative min-h-screen bg-white">
            ...
            <section className="py-12 lg:py-20 relative z-10">
                <div className="container-superhi">
                    <div className="bg-gradient-to-br from-white via-gray-50 to-lavender/30 border border-gray-200 p-8 sm:p-12 lg:p-16 rounded-[3rem] shadow-sm overflow-hidden">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-square rounded-[2.5rem] bg-gradient-to-br from-vibrant-blue/10 via-vibrant-green/10 to-vibrant-orange/10 flex items-center justify-center border border-gray-200">
            ...
            <section className="py-12 lg:py-20 relative z-10">
                <div className="container-superhi">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
                        {values.map((v) => (
                            <div key={v.title} className="relative bg-white border border-gray-200 p-10 h-full rounded-[2.5rem] shadow-sm group hover:-translate-y-1 transition-all duration-300">
