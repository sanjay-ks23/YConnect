            ...
            <div className="container-superhi relative z-10 px-4 md:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="bg-vibrant-blue p-8 sm:p-14 rounded-[2rem] sm:rounded-[2.5rem] flex flex-col justify-between min-h-[350px] group shadow-xl hover:shadow-2xl transition-all duration-500"
                    >
                        <div>
                            ...
                            <p lang="en" className="text-justify [text-align-last:justify] [text-justify:inter-word] [text-wrap:balance] [hyphens:auto] text-white/70 leading-relaxed mb-12 max-w-sm text-lg">
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-gray-900 p-8 sm:p-14 rounded-[2rem] sm:rounded-[2.5rem] flex flex-col justify-between min-h-[350px] group shadow-xl hover:shadow-2xl transition-all duration-500"
                    >
                        <div>
                            ...
                            <p lang="en" className="text-justify [text-align-last:justify] [text-justify:inter-word] [text-wrap:balance] [hyphens:auto] text-white/50 leading-relaxed mb-12 max-w-sm text-lg">
