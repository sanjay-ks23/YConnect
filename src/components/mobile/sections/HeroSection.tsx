  ...
  return (
    ...
    >
      ...
      <div className="container-superhi relative z-10 flex flex-col items-center text-center">
        <h1 className="text-4xl sm:text-5xl md:text-[4rem] font-display font-medium text-center max-w-xl mx-auto mb-6 leading-[1.15] tracking-tight">
        ...
        <p className="text-center mx-auto max-w-md text-base sm:text-lg text-[#001738]/70 leading-relaxed mb-8">
