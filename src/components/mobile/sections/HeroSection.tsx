...
export function HeroSection() {
    return (
        <section
            id="hero-section"
            className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-lavender via-white to-white py-24 sm:py-0"
        >
            ...
            <div className="container-superhi relative z-10 flex flex-col items-center text-center px-4 md:px-8 mt-12 sm:mt-0">
                <h1 className="text-[40px] sm:text-5xl md:text-7xl lg:text-8xl text-center max-w-5xl mx-auto mb-8 sm:mb-10 leading-[1.1] sm:leading-[1.05] font-display tracking-tight">
                    ...
                    <br className="hidden md:block" />
                    <span className="text-vibrant-crimson inline-block mt-2 sm:mt-4">with Indian Talent</span>
                </h1>

                <p lang="en" className="mx-auto max-w-xl text-justify [text-align-last:justify] [text-justify:inter-word] [text-wrap:balance] [hyphens:auto] text-base sm:text-xl lg:text-2xl font-normal text-foreground/70 leading-snug mb-12">
                    Skip the relocation and administration hassle. We match early stage European startups
