...
const features = [
    {
        ...
        description: "We carefully match every startup with top student talent based on specific skills, direct experience, and unique project needs.",
    ...
    },
    {
        ...
        description: "Get matched with high-quality talent within days, not weeks. Start your critical project quickly and efficiently.",
    ...
    },
    {
        ...
        description: "Regular check-ins and detailed progress tracking to ensure every part of the engagement runs perfectly smoothly.",
    ...
    },
    {
        ...
        description: "Short-term contracts with absolutely no long-term commitment. Try our platform before you decide to extend.",
    ...
    },
    {
        icon: HeartHandshake,
        title: "Full Support",
        description: "Dedicated support throughout the entire engagement — from initial onboarding to successful project completion.",
        ...
        <section className="relative w-full py-24 lg:py-32 overflow-hidden bg-transparent">
            <div className="container-superhi relative z-10">
                <div className="text-center mb-16 lg:mb-24 flex flex-col items-center">
                    ...
                    <p className="text-base sm:text-lg text-[#001738]/50 max-w-xl mx-auto mb-8 leading-relaxed px-2 text-justify">
                    ...
                    {features.map((feature, idx) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col relative z-10">
                                ...
                                <p className="text-[#001738]/50 leading-relaxed text-base lg:text-lg text-justify [text-align-last:justify]">
                                    {feature.description}
                                </p>
                            </div>
                        </motion.div>
