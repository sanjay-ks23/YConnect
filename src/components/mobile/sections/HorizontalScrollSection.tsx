...
export function HorizontalScrollSection({ title, subtitle, cards, theme, bgColor = "bg-white" }: HorizontalScrollSectionProps) {
 ...
 <p lang="en" className="text-lg lg:text-xl text-[#001738]/50 max-w-2xl">{subtitle}</p>
 </div>
 ...
 <p lang="en" className="text-xl md:text-2xl lg:text-3xl text-[#001738]/60 leading-relaxed max-w-2xl mx-auto">
 {card.description}
 </p>
 </div>
 </div>
