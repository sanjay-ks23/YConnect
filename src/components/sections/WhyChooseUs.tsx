...
const features = [
    ...
    },
    {
        ...
        description: "Get matched with highly qualified Indian talent in days. Start scaling your startup.",
    ...
    },
    {
        ...
        description: "Startups manage contracts directly. We help you find the right talent fast.",
                    ...
                    {features.map((feature, idx) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col relative z-10">
                                ...
                                <p className="text-justify-clean text-[#001738]/70 leading-relaxed text-base sm:text-lg font-normal">
                                    {feature.description}
                                </p>
                            </div>
                        </motion.div>
