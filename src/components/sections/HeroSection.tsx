    ...
    return (
        ...
        >
            ...
            <div className="container-superhi relative z-10 flex flex-col items-center text-center px-4 md:px-8">
                ...
                <div
                    className="w-max max-w-full mx-auto text-center md:[text-align:justify] md:[text-align-last:justify] text-base sm:text-lg md:text-xl text-[#001738]/70 leading-relaxed mb-10 font-normal"
