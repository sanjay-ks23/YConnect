        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-base">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className="rounded-xl h-12 bg-white border-gray-200 text-base focus:border-vibrant-crimson focus:bg-white transition-all shadow-none"
                        {...register("name")}
                    />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <select
                        id="contact-type"
                        className="flex w-full rounded-xl h-12 bg-white border border-gray-200 focus:border-vibrant-crimson focus:bg-white transition-all shadow-none px-3 py-2 text-base text-[#001738] outline-none"
